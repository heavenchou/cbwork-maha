########################################################
#
# 標點插入程式  by heaven                2004/08/14
#
# 使用方法：
# pushsign.pl 簡單標記版.txt 舊的xml.xml 結果檔xml.xml
#
########################################################
# 04/26 : 將 「『（《〈 這五個標點符號移到標記之後, 例如 「<p> => <p>「
