...
# num2vol 由經號查冊數
#
# v 1.1.1 2003/12/25 02:09下午 by Ray
# v 1.1.2 2003/12/26 08:48上午 by Ray
# v 1.2.1 2003/12/28 09:41上午 by Ray
# v 1.2.2 cbdia2unicode(), cbdia2smdia add two character: .ll, .rr, 2003-12-29 by Ray
...
# Z 卍大日本續藏經 (Manji Dainihon Zokuzokyo)
	...
	$name{"G"} = "Fojiao Canon";
	$name{"K"} = "Tripitaka Koreana";
	$name{"L"} = "Qianlong Edition of the Canon";
	$name{"M"} = "Manji Daizokyo";
	$name{"N"} = "Southern Yongle Edition of the Canon";
