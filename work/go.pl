...
$xml_root="/cbwork/xml";
$outPath="f:/release/normal";
#edith test
$xml_root="/release/app1-xml";
$outPath="c:/release/app";
...
sub do_vol  {
	...
	# app1		
		...
		#-g 去除行首(或段首)資訊的選項
		#system("xml2txt -v $vol -a -o c:/release/app1"); #edith 2005/1/24 轉 big5 app 版 一經一檔
		#system("xml2txt -e utf8 -v $vol -a -o c:/release/app1-utf8"); #edith 2005/1/25 轉 utf8 app 版
		system("xml2txt -u -v $vol -a -o c:/release/app"); #edith 2005/2/3 轉 big5 app 版 一卷一檔
